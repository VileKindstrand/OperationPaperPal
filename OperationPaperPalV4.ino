...
void loop() {
  ...
  if (buttonStateTwo == HIGH) {   // if loopen startar när knappen blir tryckt på. Så länge sensorn inte har någonting framför sig kommer motorn att rotera. Det här görs i små intervallen
    sensorThing();
    while (distance > 15) {
      sensorThing();
      actuallySpins();
